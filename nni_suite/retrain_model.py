...
if __name__ == '__main__':
    ...
    params = {"lr":0.0005,"batch_size":256.0,"order":18.0,"theta":13.4,"hidden_size":180.0,"memory_size":1,"beta_spk_u":0.4,"threshold_spk_u":0.15,"beta_spk_h":0.2,"threshold_spk_h":0.65,"beta_spk_m":0.55,"threshold_spk_m":0.9,"beta_spk_output":0.7,"threshold_spk_output":0.75}
    #dataset_path = "../data/shd"
    data_module = SMNIST(batch_size=params['batch_size'])
