...
if __name__ == '__main__':
    ...
    trainer = Trainer(accelerator='gpu', devices=[2], max_epochs=10, num_sanity_val_steps=0, enable_progress_bar=True,
                      enable_checkpointing=True,
                      logger=TensorBoardLogger(save_dir="./tensorboard", name="", version=""),
                      )
